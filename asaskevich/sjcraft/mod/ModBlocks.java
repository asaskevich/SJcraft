...
public class ModBlocks {
	...
	public static void addRecipes() {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(sugar_block), new Object[] { new ItemStack(Items.sugar), new ItemStack(Items.sugar), new ItemStack(Items.sugar),
		...
		GameRegistry.addShapelessRecipe(new ItemStack(Blocks.ice), new Object[] { new ItemStack(Blocks.snow), new ItemStack(Blocks.snow), new ItemStack(Blocks.snow),
